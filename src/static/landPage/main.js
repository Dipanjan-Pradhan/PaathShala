...
const translations = {
    ...
    hi: {
        ...
        'features.joyfulLearning.title': 'आनंदमय सीखना',
        'features.joyfulLearning.desc': 'सीखना जो खेल जैसा लगे — उद्देश्यपूर्ण, समावेशी, और जिज्ञासा जगाने के लिए बनाया गया।',
        'features.selfTracking.title': 'स्व-ट्रैकिंग',
        'features.selfTracking.desc': 'स्व-ट्रैकिंग छात्रों को अध्ययन आदतों और प्रगति को ट्रैक करने में मदद करता है ताकि वे बेहतर सीख सकें',
    ...
    or: {
        ...
        'features.joyfulLearning.title': 'ଆନନ୍ଦମୟ ଶିକ୍ଷଣ',
        'features.joyfulLearning.desc': 'ଶିକ୍ଷଣ ଯାହା ଖେଳ ପରି ଅନୁଭୂତି କରେ — ଉଦ୍ଦେଶ୍ୟପୂର୍ଣ୍ଣ, ସମାବେଶୀ, ଏବଂ ଜିଜ୍ଞାସା ଜଗାଇବା ପାଇଁ ନିର୍ମିତ।',
        'features.selfTracking.title': 'ସ୍ୱ-ଟ୍ରାକିଙ୍ଗ',
        'features.selfTracking.desc': 'ସ୍ୱ-ଟ୍ରାକିଙ୍ଗ ଛାତ୍ରମାନଙ୍କୁ ଅଧ୍ୟୟନ ଅଭ୍ୟାସ ଏବଂ ପ୍ରଗତି ଟ୍ରାକ କରିବାରେ ସାହାଯ୍ୟ କରେ ଯାହା ଉନ୍ନତ ଶିକ୍ଷା ପାଇଁ',
    ...
    bn: {
        ...
        'features.joyfulLearning.title': 'আনন্দময় শিক্ষা',
        'features.joyfulLearning.desc': 'শিক্ষা যা খেলার মতো অনুভূতি দেয় — উদ্দেশ্যপূর্ণ, অন্তর্ভুক্তিমূলক, এবং কৌতূহল জাগানোর জন্য তৈরি।',
        'features.selfTracking.title': 'স্ব-ট্র্যাকিং',
        'features.selfTracking.desc': 'স্ব-ট্র্যাকিং শিক্ষার্থীদের অধ্যয়ন অভ্যাস এবং অগ্রগতি ট্র্যাক করতে সাহায্য করে যাতে তারা ভালো শিখতে পারে',
